...
CREATE FUNCTION create_text_search_storage ( _model_name text, _document_type_name text, _store_content bool, _createIndex bool DEFAULT TRUE ) RETURNS int53 AS $$
DECLARE
    _id int53;
BEGIN
    ...
    ( model_id, document_type_id, store_content )
    VALUES
    (
...
CREATE FUNCTION create_text_search_document ( _storage_id int53, _content text, _vector vector json ) RETURNS int53 AS $$
DECLARE
    _document_id int53;
    _embedding_id int8;
BEGIN
