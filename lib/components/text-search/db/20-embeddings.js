...
CREATE FUNCTION create_text_search_storage ( _model_name text, _document_type_name text, _store_content bool, _unique_document bool, _createIndex boolean DEFAULT TRUE ) RETURNS int53 AS $$
DECLARE
    _id int53;
BEGIN
