...
export default class {
    ...
    async init () {
        ...
        res = await this.createStorage( "Xenova/all-MiniLM-L6-v2", "RETRIEVAL_QUERY", {
            "storeContent": true,
            "uniqueDocument": true,
        } );
...
` );
    ...
    async createStorage ( modelName, documentTypeName, { storeContent, uniqueDocument, createIndex = true, dbh } = {} ) {
        dbh ||= this.dbh;
